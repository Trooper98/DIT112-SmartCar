...
//---------- Sensors ----------
Sonar front, backR; //front and back sonars
...
//---------- Extra ----------
const float mainSpeed = .125; // meters per sec
const float reverseSpeed = .05; // meters per sec
...
void setup() {
  ...
  car.enableCruiseControl(); //this maintains a stable direction.
}
...
void servoTurn() {
  int pos = 0;
  for (pos = 0; pos <= 75; pos += 1) { // goes from 0 degrees to 180 degrees in steps of 1 degree
